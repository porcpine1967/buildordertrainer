var civs = {
    ...
    britons:  { strategy: 'Archers with CA pikes',
                dark_headers: ['Sheep', 'Wood', 'Boar', 'Berries', 'Boar to farms', 'Wood'],
    ...
    celts:  { strategy: 'Men-at-arms to Fast Castle; Pikes guarding siege',
    ...
    chinese:  { strategy: 'Scout to Skirms',
    ...
    franks: { strategy: 'Fast Castle to Knight Rush',
    ...
    mayans: { strategy: 'Archers to Castle Age Plumes and/or Eagles',
              dark_headers: ['Sheep', 'Wood', 'Boar', 'Berries', 'Boar to farms', 'Wood'],
              dark_values: [6, 4, 2, 4, 1, '5 (9)'],
              dark_instructions: '',
              fup_instructions: 'While advancing: 2 sheep to wood (11), 3 to gold; build 1 barracks',
    ...
    mongols: { strategy: 'Scouts to skirms',
    ...
    persians: { strategy: 'Scouts into Knights',
                dark_headers: ['Sheep', 'Wood', 'Boar', 'Berries', 'Boar to farms', 'Wood'],
    ...
    slavs: { strategy: 'Man-at-arms rush with 2 barracks, followed by mangonels or rams',
